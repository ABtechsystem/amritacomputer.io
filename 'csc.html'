...
<nav class="nav  navbar-expand-lg dark-nav  navbar-fixed-top">
 ...
 <div class="container">
        <div class="row">
        <div class="gallery col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-top:50px;">
            <h1 class="gallery-title text-center">Gallery</h1>
        </div>

        <div align="center" class="text-center col-lg-12 col-md-12 col-sm-12 col-xs-12" >
            <button class="btn btn-default filter-button" data-filter="all">All</button>
            <button class="btn btn-default filter-button" data-filter="2014">Anuual Function 2014</button>
            <button class="btn btn-default filter-button" data-filter="2018">Anuual Function 2018</button>
            <button class="btn btn-default filter-button" data-filter="2020">Anuual Function 2020</button>
